...
This repository contains my day-wise solutions to the **Striver's SDE Sheet (191 Problems)** — one of the most recommended and structured problem sets for cracking coding interviews at companies like Google, Amazon, Microsoft, Facebook, Swiggy, and Flipkart.
...
Each file is named after the problem it solves, with comments explaining the approach and complexity.
